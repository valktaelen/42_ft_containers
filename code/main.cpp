...
/*   Updated: 2022/09/19 23:09:15 by aartiges         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
#include <stack>
#include <vector>
#include "includes/containers/map/map.hpp"
#include "includes/containers/stack.hpp"
#include "includes/containers/vector/vector.hpp"
...
int main(int argc, char** argv) {
	...
	{
		//NORMAL ! :P
		std::cout << "Exception (normal)" << std::endl;
	}
	
	std::cout << "insert" << std::endl;
	for (int i = 0; i < COUNT; ++i)
	{
		map_int.insert(NAMESPACE::make_pair(rand() % seed, rand() % seed));
	}
